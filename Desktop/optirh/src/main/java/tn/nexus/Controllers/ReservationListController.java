...
public class ReservationListController {
    ...
    private final User currentUser = new User(1,"ikbel","ikbel.hamdi@esprit.tn","ikbelhamdi123","Admin","Esprit");
    ...
    private void updateReservationList() throws SQLException {
        observableReservations = FXCollections.observableArrayList(reservationService.getReservationsByUserID(currentUser));
